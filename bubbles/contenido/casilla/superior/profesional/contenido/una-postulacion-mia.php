...
?>
	...
	<div style="clear: both">
		...
		<?php
		if($este_aviso->status == 'TRABAJO_ASIGNADO' && $visitado->id_usuario == $este_aviso->id_usuario_asignado){
			echo '<p class="parrafo8" style="color: #ff0000; float: left; margin-left: 10px; margin-top: 0px; margin-bottom: 0px;">POSTULACIÓN ACEPTADA</p>';
		}
		?>
