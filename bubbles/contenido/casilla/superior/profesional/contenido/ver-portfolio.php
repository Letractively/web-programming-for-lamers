...
<div class="contenido-portfolio">
	...
	<div class="recorrer-portfolio">
		<a href="u-galeria.php?entidad_visitada=<?php echo $_GET['entidad_visitada']; ?>&solapa_superior=portfolio&botonera_superior=ver_portfolio&contenido_superior=ver_portfolio&mi_portfolio_offset=<?php echo $_GET['mi_portfolio_offset'] - 6 ?>">
