...
?> 
                ...
                <div style="width:900px; position:relative;  z-index:3;">
    	            <div style="width:900px; height:500px; padding:20px 0 0 20px;">
                            ...
                            <div style="font-size:12px; font-weight:bold;" class="userlist">
                            ...
                            <div style="font-size:12px; clear:both;">
                                ...
                                ?> 
                                    ...
                                    <div style="border-top:1px solid #d3eebd; height:22px; width:850px; <?php echo($row->type==12) ? "color:#e00;" : ""; ?>">
