...
?>
        ...
        <div style="margin:10px 45px 20px 20px;">
            <div style="float:left;">
                <h1 style="color:#bebebe;"> Catálogo </h1>
                <h3>Misc</h3>
            </div>
			...
			<!-- gallerific start -->       
				...
				<div id="thumbs" class="navigation" style="float:left; width:350px;">
					<ul class="thumbs noscript">
						<li>
							<a class="thumb" href="img/gal/foto1.jpg" title="Vestido de Danza 1">
								<img src="img/gal/foto1-thumb.jpg" alt="Vestido de Danza 1" />
							</a>
							<div class="caption">
								<div class="image-title">Vestido de Danza 1</div>
								<div class="image-desc">
                                	Lorem ipsum dolor sic amet consectetur adepescit et astra in dolorem natura. 
	                                In sic torrentes perspitia presentum ar nosber.
                                    <br />
                                    <ul>
	                                    <li>Distancia de pierna 27cm.</li>
									    <li>50% polyester, 50% polybutyleno.</li>
                                    </ul>
                                    
									<b>Colección:</b> Nubia.<br />
									<b>Etc:</b> Etc.<br />
									
                                    <div style="border-top:1px solid #ccc; margin:10px 0 0 0; padding:10px 0 0 0;">
										<b>Colores disponibles:</b><br />
                                        
                                        <div class="colorblock" style="background-color:#1f1a17;"></div>
                                        <div class="colorblock" style="background-color:#27283c;"></div>
                                        <div class="colorblock" style="background-color:#266cbc;"></div>
                                        <div class="colorblock" style="background-color:#d03628;"></div>
                                        <div style="clear:both; height:10px;"></div>
                                        
										<b>Tamaños:</b><br />
                                        
                                        <div class="sizeblock">28</div>
                                        <div class="sizeblock">30</div>
                                        <div class="sizeblock">32</div>
                                        <div class="sizeblock">34</div>
                                        <div class="sizeblock">36</div>
                                        <div class="sizeblock">38</div>
                                        <div class="sizeblock">40</div>
