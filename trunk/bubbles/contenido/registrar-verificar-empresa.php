...
$codigohtml = '<html><head><title>' . $nuevoReg->alias_usuario . ', Bienvenido a Buubles!. Clickee en el siguiente vinculo para confirmar su postulacion:</title></head><body><a href=' . URL_BASE . '/registrar-nuevo-usuario.php?id=' . $nuevoReg->id_usuario . '&amp;reg=' . $nuevoReg->contrasenia . '">Verificar mi Memresia</a>"';
$email = $nuevoReg->email_usuario;
$asunto = $nuevoReg->alias_usuario . ', bienvenido a BUBBLES. Confirme su membresia a continuación:';
