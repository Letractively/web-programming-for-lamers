<div class="col-central registro-verificado">
	<div class="contenido-cartel">
		<h2 class="al-medio"><?php echo $confirmaReg->alias_usuario; ?>, Bienvenido a la Comunidad Bubbles!!</h2>
		<p class="parrafo8 al-medio">Su registro se completó exitosamente.</p>
		<p class="parrafo8 al-medio">Logueese <a href="<?php echo URL_BASE; ?>">en su casilla correspondiente desde este vínculo</a> 
