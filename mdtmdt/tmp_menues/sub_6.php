...
function cambiarsub(item,cod,t) {
	...
	parent.frames['derecha'].location='<?=CFG_virtualPath?>carga_derecha.php?id_sel=6&menu=0&id_sub_sel='+cod;
...
<table border=0 cellpadding='1' cellspacing=1 width="100%" class="divisor">
  ...
  <!--	<td width="1"><img src="../images/flechaitemmunozover2.gif" border="0"></td>-->
    <td><a class="link1" id="xuno" href="javascript:cierratodo();cambiar('',19,'<?=traducemenu(19)?>');"><?=traducemenu(19)?></a></td>
  </tr>
</table>
...
<table border=0 cellpadding='1' cellspacing=1 width="100%">
  <tr>
  <!--	<td width="1"><img src="../images/flechaitemmunozover2.gif" border="0"></td>-->
    <td class="divisor"><a class="link1"  href="javascript:cambiar('',168,'<?=traducemenu(168)?>');"><?=traducemenu(168)?></a></td>
  </tr>
</table>
...
<table border=0 cellpadding='1' cellspacing=1 width="100%">
  <tr>
   <!-- <td width="1"><img src="../images/flechaitemmunozover2.gif" border="0"></td>-->
    <td class="divisor"><a class="link1" href="javascript:cambiar('',169,'<?=traducemenu(169)?>');"><?=traducemenu(169)?></a></td>
  </tr>
</table>
...
<table border=0 cellpadding='1' cellspacing=1 width="100%" >
  <tr>
  <!--	<td width="1"><img src="../images/flechaitemmunozover2.gif" border="0"></td>-->
    <td class="divisor"><a class="link1" href="javascript:cambiar('',170,'<?=traducemenu(170)?>');"><?=traducemenu(170)?></a></td>
  </tr>
</table>
...
parent.frames['centro'].location='../carga_contenido.php?id_sel=6&tit=<?=traducemenu(6)?>';
parent.frames['derecha'].location='../carga_derecha.php?id_sel=6';
