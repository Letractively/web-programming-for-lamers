...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	<form method="post" action="<?= $_SERVER['PHP_SELF']?>?<?= $_SERVER['QUERY_STRING']?>">
		...
		<tr class="espacio">
		  ...
		  <td width="33%"><input name="imageField" type="image" src="images/btn-buscar-mdt.jpg" width="25" height="25" border="0" onClick="javascript:document.form.submit()"></td>
		</tr>
	</form>
</table>
<?
	...
	$db->select( 'prensa', '*', "1=1 $and1","fecha desc");
?>
				...
				<table width="95%" border="0">
				  ...
				  <tr>
					...
					<td rowspan="3" align="center" valign="top">
						<img src="./images/<?=$bandera[$links->socio]?>.gif" border="0"><br>&nbsp;<br>
						<?
						if($links->pdf != ''){
						?>
				  ...
				  <tr>
					<td>&nbsp;</td>
					<td class="style9" align="left"><?=$links->medio?> <?=$links->areas ==1 && $links->paginas>0? '/Pág':'';?> <?=$links->paginas?></td>
					<td>&nbsp;</td>
				  </tr>
				  <tr>
					<td>&nbsp;</td>
					<td class="style9" align="left"><b><?=$links->{'titulo_'.$lng}?></b></td>
					<td>&nbsp;</td>
				  </tr>
				<?
					if($links->link != ''){
